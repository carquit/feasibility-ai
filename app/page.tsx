...
export default function App() {
  ...
  return <main id="top">
    ...
    <footer className="footer section-shell"><Brand /><p>Evidence-to-decision intelligence for ambitious AI projects.</p><div><a href="#product">Product</a><a href="#method">Method</a><a href="#pricing">Pricing</a></div><small>© {year} Feasibility.ai</small></footer>
  </main>;
}
